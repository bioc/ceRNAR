...
ceFunction_results <- ceRNAFunction(project_name = 'demo', disease_name = 'DLBC', pairs_cutoff = 1, kegg_p_cutoff = 0.01, kegg_top = 10, go_p_cutoff = 0.05, go_q_cutoff = 0.05, go_top = 10)
```
